...
-- Looks at Global Total Cases and Total Deaths
...
-- Looks at Covid Mortality Count by Continent
SELECT location, MAX(cast(total_deaths as int)) as [HighestMortalityCount]
FROM [Portfolio Project]..CovidDeaths
...
-- Looks at percent of a locations population that has been infected
...
-- Looks at population infection rate as a rolling number
